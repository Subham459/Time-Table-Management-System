...
<div class="navbar navbar-inverse navbar-fixed-top " id="menu">
    <div class="container">
        <div align="center">
            <h3 align="center">TIME TABLE MANAGEMENT SYSTEM, ABCD UNIVERSITY </h3>
        </div>
    </div>
</div>
...
<div id="myCarousel" class="carousel slide" data-ride="carousel">
    ...
    <div class="carousel-inner" role="listbox">
        <div class="item active">
            <img src="assets/img/pic/lab1.jpg" alt="Chania">
        </div>

        <div class="item">
            <img src="assets/img/pic/lab2.jpg" alt="Chania">
        </div>

        <div class="item">
            <img src="assets/img/pic/lab1.jpg" alt="Flower">
        </div>

        <div class="item">
            <img src="assets/img/pic/lab2.jpg" alt="Flower">
        </div>
    </div>
</div>
...
<div align="center">
    <form data-scroll-reveal="enter from the bottom after 0.2s" action="studentvalidation.php" method="post">
        <select id="select_semester" name="select_semester" class="list-group-item">
            ...
            <option value="3"> BCA I Year ( Semester I )</option>
            <option value="4"> BCA I Year ( Semester II )</option>
            <option value="5"> BCA II Year ( Semester III )</option>
            <option value="6"> BCA II Year ( Semester IV )</option>
            <option value="7"> BCA III Year ( Semester V )</option>
            <option value="8"> BCA III Year ( Semester VI )</option>
        </select>
        ...
        <div class="row">
            ...
            <div class="col-lg-4  col-md-4 col-sm-4" data-scroll-reveal="enter from the bottom after 0.4s">
                <div class="faculty-div">
                    <img src="assets/img/faculty1/dean.jpeg" class="img-rounded"/>
                    <h3 align="center">Prof. Dhrubashish Sarkar</h3>
                    <hr/>
                    <h4 align="center">HOI<br/>Computer Science Department</h4>

                </div>
            </div>
            <div class="col-lg-4  col-md-4 col-sm-4" data-scroll-reveal="enter from the bottom after 0.5s">
                <div class="faculty-div">
                    <img src="assets/img/faculty1/principal.jpeg" class="img-rounded"/>
                    <h3 align="center">PROF.Supriya Chakraborty</h3>
                    <hr/>
                    <h4 align="center">Assistant Professor(senior)<br/> AIIT</h4>

                </div>
            </div>
            <div class="col-lg-4  col-md-4 col-sm-4" data-scroll-reveal="enter from the bottom after 0.6s">
                <div class="faculty-div">
                    <img src="assets/img/faculty1/chairman.jpg" class="img-rounded"/>
                    <h3 align="center">Atul Chauhan</h3>
                    <hr/>
                    <h4 align="center">Chairman<br/>ABCD University</h4>
    ...
    <div class="row set-row-pad">
        <div class="col-lg-4 col-md-4 col-sm-4   col-lg-offset-1 col-md-offset-1 col-sm-offset-1 "
            ...
            <div>
                ...
                <h4>India - 700135</h4>
                <h4><strong>Call:</strong>1800220022002 </h4>
                <h4><strong>Email: </strong>admissions@kol.amity.edu</h4>
            </div>
